  ...
  data: function data() {
    return {
      ...
      tarbarList: [{
        id: 1,
        text: '首页',
        url: __webpack_require__(/*! @/static/icon/home.png */ 304),
        checkUrl: __webpack_require__(/*! @/static/icon_che/home.png */ 305),
        path: '/pages/home/index'
      }, {
        id: 2,
        text: '关于基金',
        url: __webpack_require__(/*! @/static/icon/aixin.png */ 306),
        checkUrl: __webpack_require__(/*! @/static/icon_che/aixin.png */ 307),
        path: '/pages/about/index'
      }, {
        id: 3,
        text: '我的',
        url: __webpack_require__(/*! @/static/icon/my.png */ 308),
        checkUrl: __webpack_require__(/*! @/static/icon_che/my.png */ 309),
        path: '/pages/my/index'
      }]
    };
  },

...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/components/charitableFunds/index.vue */ 132));
// @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_64a948b6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=64a948b6& */ 133);
...
var cardFunds = function cardFunds() {
  __webpack_require__.e(/*! require.ensure | components/card_funds/index */ "components/card_funds/index").then((function () {
    return resolve(__webpack_require__(/*! @/components/card_funds/index.vue */ 249));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var textSwiper = function textSwiper() {
  __webpack_require__.e(/*! require.ensure | components/text_swiper/index */ "components/text_swiper/index").then((function () {
    return resolve(__webpack_require__(/*! @/components/text_swiper/index.vue */ 256));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var _default = {
  components: {
    ...
    _joinDonate: function _joinDonate() {
      ...
      if (this.form.money > 0) {
        (0, _api.joinDonate)({
          ...
          _this4.$store.commit('configInfo');
        });
      } else {
        uni.showToast({
          title: '捐款金额大于0!',

			...
			<view class="mt30 flex  bg-white p20 radius10">
				...
				<view class="ml20">
					...
					<view class="flex mt10 justify-between items-center">
						<view class="text36 colD6B07A font-bold">{{jfDetails.integral}}<text
								class="ml10 text18 mr10">积分</text> </view>
						<view class="flex ">
							<image src="../../../static/order_left.png" class="orderImg" @click="handleJ('1')" mode="">
							</image>
							<view class="bgEBEBEB px30 line62"> {{number}} </view>
							<image src="../../../static/order_right.png" class="orderImg" @click="handleJ('2')" mode="">
							</image>
						</view>
					</view>
				</view>
			...
			<view class="mt30 bg-white p20 radius10">
				...
				<view class="mt77 px10">
					<view class="btnForm" @click="handOk"
						v-if="Number(userInfo.integral)-Number(jfDetails.integral*number)>=0">
						确认兑换
					</view>
					...
					<view class="p30">
						<view class="p30 text24">
							...
							<view class="flex justify-between items-center mt30">
								<view>电话</view>
								<view class="text-right"><input v-model="form.mobile" type="text"

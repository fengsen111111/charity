		...
		<view class="bg-white">
			<view class="p35">
				<view class="border205D57 col9B9B9B text24 flex p10 items-center radius30">
					...
					<view class="ml10"><input type="text"  v-model="rearch" class="col-black" @blur="_getActivityList"
							placeholder="请输入活动信息" /></view>
				</view>
			</view>
				...
				<view class="py5 ml20">
					<view class="titleView text-center text26 col205D57 hidden scrollable">
						<view class="flex items-center ml10">
							<view class="px10" @click="handleIndex('')">
								<view :class="checkIndex==''?'checkIndex':''">全部</view>
							</view>

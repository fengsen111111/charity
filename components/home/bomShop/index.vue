	...
	<view class="">
		<view class="grid grid-cols-2 gridRow">
			<view class="bg-whilt rending1 p-2 mt-3" v-for="item in [1,2,3,4]" :key="item">
				...
				<image v-else-if="item ==2" @click="handDetailds" src="https://img.picui.cn/free/2024/08/29/66cfcffbc9dcb.png" mode="" class="w-full h10"></image>
				<image v-else-if="item ==3" @click="handDetailds" src="https://img.picui.cn/free/2024/08/29/66cfcffbc9dcb.png" mode="" class="w-full h10"></image>
